...
while len(guessed_nums) < allowed_guesses:
    ...
    if not player_num > 0 or not player_num < 26:
        print("That number isn't between 1 and 25!")
        break
    ...
    if player_num == rand_num:
        ...
        if rand_num > player_num:
            print("Nope, My number is higher than {}.  That was guess #{}.".format(player_num, len(guessed_nums)))
        else:
            print("Nope My number is lower than {}.  That was guess #{}.".format(player_num, len(guessed_nums)))
        continue
